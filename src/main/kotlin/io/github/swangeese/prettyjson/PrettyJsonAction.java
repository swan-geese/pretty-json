...
//
//
//public class PrettyJsonAction extends AnAction {
//    @Override
...
//                String prettyJson = jsonObject.toString(4); // 4是缩进空格数
//                WriteCommandAction.runWriteCommandAction(editor.getProject(), () -> {
//                    editor.getDocument().replaceString(selectionModel.getSelectionStart(), selectionModel.getSelectionEnd(), prettyJson);
//                });
//            } catch (Exception ex) {
//                // 处理 JSON 解析错误
